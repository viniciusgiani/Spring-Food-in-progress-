package com.spring.data.core.springdoc;

import com.spring.data.api.exceptionhandler.Problem;
...
public class SpringDocConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        new Tag().name("Statistics").description("Statistics")
    ...
    private Map<String, ApiResponse> generateResponses() {
        ...
        apiResponseMap.put(notAcceptableResponse, new ApiResponse()
                .description("Resource has no acceptable representation")
                .content(content));
