...
public class AuthorizationServerConfig {
    ...
    @Bean
    public AuthorizationServerSettings providerSettings(FoodSecurityProperties properties) {
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwtCustomizer(UserRepository userRepository) {
        return context -> {
            ...
            if (authentication.getPrincipal() instanceof User) {
                ...
                com.spring.data.domain.model.User user1 = userRepository.findByEmail(user.getUsername()).orElseThrow();
                ...
                context.getClaims().claim("user_id", user1.getId().toString());
