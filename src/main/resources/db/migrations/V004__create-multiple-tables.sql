...
alter table restaurant_payment add constraint fk_rest_payment_payment_method
foreign key (payment_id) references payment (id);

alter table restaurant_payment add constraint fk_rest_payment_method_restaurant
foreign key (restaurant_id) references restaurant (id);
